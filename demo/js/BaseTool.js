...
BaseTool.prototype = {
	...
	drag : function (baseMode, isLine, brokenType, isText, isButton) {
		...
		baseMode.onmousedown = function(event) {
   		...
   		*/
				event.pageX = event.pageX ? event.pageX : event.clientX;
				event.pageY = event.pageY ? event.pageY : event.clientY;
   			...
   			if (isCreate) {
   				...
   				if (isLine) {
   					...
   					global.modeTool.create(ty, tx, imgSrc, isText, isButton);
   				}
